...
Console.WriteLine("Michael Banko");
...
string[] names2 = new[] { "Kait", "Kyle", "Michael", "Patrick" };
...
{
  { "Alexa", "Bixby", "Google", "Siri" },
  { "Germany", "France", "Spain", "Portugal" },
  { "49ers", "Bears", "Cowboys", "Packers" }
};
...
grid2[0, 0] = "Start"; // assign string values
// and so on
grid2[2, 3] = "Finish";

string[][] jagged = new[] // array of string arrays
{
  new[] { "Alexa", "Bixby", "Google" },
  new[] { "Germany", "France", "Spain", "Portugal" },
  new[] { "49ers", "Bears" }
};
